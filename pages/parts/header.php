...
} elseif(isset($_SESSION['loginDone']) && isset($_GET['search'])){
    echo 'Das ist die Seite, auf der Du nach Erinnerungen suchen kannst, '.  $_SESSION['name'] . '.';
} elseif(isset($_SESSION['loginDone']) && isset($_GET['seeLast'])){
    echo 'Das sind die zuletzt erstellten Erinnerungen, '.  $_SESSION['name'] . '.';
} elseif(isset($_SESSION['loginDone']) && isset($_GET['delete'])){
    echo 'Hier kannst du Erinnerungen löschen, '.  $_SESSION['name'] . '.';
} elseif (isset($_SESSION['loginDone']) && isset($_GET['change'])) {
